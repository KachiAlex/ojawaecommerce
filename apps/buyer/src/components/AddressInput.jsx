    ...
    <div className="space-y-3">
      ...
      <div>
        <input
          ...
          placeholder="Country"
          className="w-full border border-gray-300 rounded-lg px-3 py-2 bg-gray-50 text-slate-900 placeholder:text-slate-400 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
          disabled={readOnly}
        />
      </div>
